...
namespace ShopEase
{
    public class AislesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AisleID,AisleName,StoreSection")] Aisle aisle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AisleID,AisleName,StoreSection")] Aisle aisle)
        {
            if (id != aisle.AisleID)
            {
                return NotFound();
